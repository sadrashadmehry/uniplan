...
export function SchedulePlanner({ user }: { user: User }) {
  ...
  async function exportPng() {
    ...
    exams.forEach((course, index) => {
      ...
      const dateLabel = formatPersianFullDate(course.examDate);
      context.fillStyle = exportColor(course.color);
      ...
      context.direction = "ltr";
      context.textAlign = "left";
      context.fillText(formatExamWeekday(course.examDate), 132, rowY + 36);
      ...
      context.fillText(formatExamTime(course.examDate), 1248, rowY + 23);
    });
    context.direction = "ltr";
    context.textAlign = "left";
...
function exportColor(color: CourseColor) {
